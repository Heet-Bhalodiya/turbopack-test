...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      'bg-backdrop data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50',
      className
    )}
    {...props}
    ref={ref}
  ...
  'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 gap-4 p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
        ...
        left: 'bs-full is-full data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left max-is-[300px] inset-y-0 left-0 border-r',
        right:
          'bs-full is-full data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right max-is-[300px] inset-y-0 right-0 border-l'
      }
    },
    defaultVariants: {
      side: 'right'
